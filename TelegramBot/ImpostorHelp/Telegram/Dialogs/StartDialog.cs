        ...
        CancellationToken cancellationToken)
    {
        ...
        else if (update.CallbackQuery.Data == "StartDialog.2Level.Yes")
        {
            var level2YesMessage = "Понимаю. Ощущать это неприятно, но я здесь неспроста! " +
                                   "\nБританские учёные нашептали мне, что феномен самозванца — это ошибка мышления. " +
                                   "Если ты сможешь немного изменить привычное восприятие себя и мира, у тебя получится не поддаваться влиянию феномена самозванца." +
                                   "\nПриступим?";
            await botClient.SendTextMessageAsync(
                chatId: chatId,
        ...
        {
            var level2NoMessage =
                "Отличная новость! Если для тебя это действительно неактуально, ты можешь не прибегать к моей помощи." +
        ...
        else if (update.CallbackQuery.Data == "StartDialog.3Level.Yes")
        {
            var level3YesMessage = "Как именно я могу тебе помочь? " +
                                   ...
                                   "\n— получить поддержку от создателей бота (потому что и им не понаслышке знаком этот феномен);" +
        ...
        else if (update.CallbackQuery.Data == "StartDialog.4Level.Yes")
        {
            var level4Message =
                ...
                "\nПри необходимости ты сможешь поменять время в настройках, используя команду /notification";
            await botClient.SendTextMessageAsync(
                chatId: chatId,
                text: level4Message,
                cancellationToken: cancellationToken,
        ...
        {
            var level6Message = "Напиши текст, обращаясь к себе в будущее. Текст должен начинаться со слов \"Воспоминание:\" " +
                                ...
                                "\n \nНапиши сообщение, отправь его мне, а затем нажми на кнопку “Написал(а)";
            await botClient.SendTextMessageAsync(
                chatId: chatId,
                text: level6Message,
                cancellationToken: cancellationToken,
        ...
        {
            var message = "Напиши текст, обращаясь к себе в будущее. Текст должен начинаться со слов \"Воспоминание:\"" +
                          "\n \nШаг 1: Ситуация" +
        ...
        else if (update.CallbackQuery.Data == "StartDialog.10Level.Ok")
        {
            var message = "Отлично! Теперь ты точно готов(а) к встрече с феноменом самозванца. " +
                          "\nНо пускай он не посетит тебя ни завтра, ни сегодня." +
                          "\n\nДо встречи!";
        ...
        {
            var message = "Всего хорошего тебе! Если решишь пообщаться со мной, зайди в меню и нажми START";
